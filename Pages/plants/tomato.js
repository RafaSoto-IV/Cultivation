...
function check(left, top){
  ...
  console.log(l[0], t[0])
  console.log("offsetLeft: " + document.getElementById("tomato").offsetLeft, "offsetTop: " + document.getElementById("tomato").offsetTop);
  var left = document.getElementById("tomato").offsetLeft;
  var top = document.getElementById("tomato").offsetTop;
  if(t[0] > top && t[0] < (top + 250)){
    if (l[0] > left && l[0] < (left + 250)) {
      //console.log(found_plant.id);
      var x = getCookie('tomato');
...
function water(){
  // console.log(tomato.plant_name);

  setCookie("tomato", "tomato", 20);
  startTimer(20);
  clearTimeout(v);
  rotate();
